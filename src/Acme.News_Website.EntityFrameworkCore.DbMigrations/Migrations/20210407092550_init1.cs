        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppCategories_AppCategories_IdParent",
                        column: x => x.IdParent,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NotiState = table.Column<int>(type: "int", nullable: false),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RatingPoint = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppBlogs_AppCategories_IdCategory",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdBlog = table.Column<Guid>(type: "uniqueidentifier", maxLength: 128, nullable: false),
                    IdUser = table.Column<Guid>(type: "uniqueidentifier", maxLength: 128, nullable: false),
                    RatingPoint = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    ExtraProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppBlogReviews", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppBlogReviews_AppBlogs_IdBlog",
                        column: x => x.IdBlog,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppComments_AppBlogs_IdBlog",
                        column: x => x.IdBlog,
                        principalTable: "AppBlogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ImgTitle = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppTrackings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppTrackings_AppBlogs_IdBlog",
                        column: x => x.IdBlog,
                        principalTable: "AppBlogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogTag_AppBlogs_BlogsId",
                        column: x => x.BlogsId,
                        principalTable: "AppBlogs",
                        principalColumn: "Id"
                        //onDelete: ReferentialAction.Cascade
                    ...
                    table.ForeignKey(
                        name: "FK_BlogTag_AppTags_TagsId",
                        column: x => x.TagsId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppBlogReviews_IdBlog",
                table: "AppBlogReviews",
                column: "IdBlog");

            migrationBuilder.CreateIndex(
                name: "IX_AppBlogs_IdCategory",
                table: "AppBlogs",
                column: "IdCategory");

            migrationBuilder.CreateIndex(
                name: "IX_AppCategories_IdParent",
                table: "AppCategories",
                column: "IdParent");

            migrationBuilder.CreateIndex(
                name: "IX_AppComments_IdBlog",
                table: "AppComments",
                column: "IdBlog");
