...
{
    [DbContext(typeof(News_WebsiteMigrationsDbContext))]
    [Migration("20210511020316_remove-idcateintag")]
    partial class removeidcateintag
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acme.News_Website.BlogImages.BlogImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.ToTable("AppBlogImages");
                });

            modelBuilder.Entity("Acme.News_Website.BlogReviews.BlogReview", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("AppBlogReviews");
                });

            modelBuilder.Entity("Acme.News_Website.Blogs.Blog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.Comments.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.Images.Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("UserProfileImg")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Acme.News_Website.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.Tags.Tag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.Trackings.Tracking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Acme.News_Website.BlogImages.BlogImage", b =>
                {
                    b.HasOne("Acme.News_Website.Blogs.Blog", null)
                        .WithMany()
                        .HasForeignKey("IdBlog")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Acme.News_Website.Images.Image", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.News_Website.Blogs.Blog", b =>
                {
                    b.HasOne("Acme.News_Website.Categories.Category", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Acme.News_Website.Categories.Category", b =>
                {
                    b.HasOne("Acme.News_Website.Categories.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("BlogTag", b =>
                {
                    ...
                    b.HasOne("Acme.News_Website.Tags.Tag", null)
                        .WithMany()
